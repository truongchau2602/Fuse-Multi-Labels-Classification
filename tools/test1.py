...
def main():
    ...
    if args.from_file:
        ...
        for d, dataset in enumerate(dataset_list):
            ...
            print('Line 226 - test.py: Model.classes', model.CLASSES)
...
# # resource is not supported in windows 
# # please use psutil instead
# # import resource
# import psutil

# # This code is only available in Unix-like system
# # rlimit = resource.getrlimit(resource.RLIMIT_NOFILE)
# # resource.setrlimit(resource.RLIMIT_NOFILE, (20480, rlimit[1]))

# # alternative code by using psutil
# rlimit = psutil.RLIMIT_NOFILE
# soft_limit, hard_limit = psutil.getrlimit(rlimit)
# psutil.setrlimit(rlimit, (20480, hard_limit))
