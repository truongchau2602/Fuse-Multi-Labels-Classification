...
class DistributedSampler(_DistributedSampler):
    ...
    def __init__(self, dataset, num_replicas=None, rank=None, shuffle=True):
        ...
        print("\n\nmltt/datasets/loader/sampler.py/")
        print("line 16  DistributedSampler")
...
class RandomCycleIter:
    ...
    def __init__(self, data_list, test_mode=False):
        # print("line 233 sampler.py  RandomCycleIter")
    ...
    def __next__(self):
        ...
        # print(f"self.data_list[self.i] = {self.data_list[self.i]}")
...
class ClassAwareSampler(Sampler):
    ...
    def __init__(self, data_source, num_samples_cls=3, reduce = 4):
        print("\n\n nmltt/datasets/loader/sampler.py/")
        print("line 276  ClassAwareSampler")
        random.seed(0)
        torch.manual_seed(0)
        ...
        print("line 293  ClassAwareSampler get_index_dic begin")
        self.cls_data_list, self.gt_labels = data_source.get_index_dic(list=True, get_labels=True)
        print("line 295  ClassAwareSampler get_index_dic end")
        print(f"cls_data_list= {self.cls_data_list}")
        print(f"len(cls_data_list)= {len(self.cls_data_list)}")
        print(f"len(gt_labels)= {len(self.gt_labels)}")
        # print(f"gt_labels= {self.gt_labels}")
        self.num_classes = len(self.cls_data_list)
        print("data_iter_list begin")
        # for x in self.cls_data_list:
        #     print(x)
      
        self.data_iter_list = [RandomCycleIter(x) for x in self.cls_data_list] # repeated
        print("data_iter_list end")
