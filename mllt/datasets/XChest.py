...
class XChestDataset(Dataset):
  ...
  def load_annotations(self, ann_file, LT_ann_file=None):
    ...
    # Get id col
    img_infos = self._get_col_in_csv(ann_file, 5)
  ...
  def get_ann_info(self, idx):
    ...
    label_value = row.iloc[0][6:32].values
  ...
  def get_index_dic(self, list=False, get_labels=False):
    ...
    for i, img_path in enumerate(self.img_infos):
