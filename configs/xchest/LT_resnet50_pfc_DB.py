...
model = dict(
    ...
    head=dict(
        ...
        loss_cls=dict(
            ...
            loss_weight=1.0, freq_file='mllt/appendix/chestdevkit_part_0_part_0_part_0_part_1/class_freq.pkl')))
...
data = dict(
    ...
    train=dict(
            type=dataset_type,
            ann_file=data_root + '/label/part_0_part_0_part_0_part_1.csv',
            LT_ann_file = None,
