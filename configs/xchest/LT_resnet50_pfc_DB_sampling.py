...
data_root = '/content/drive/MyDrive/ICCV-CXR/Link/official_data_iccv_2'
...
data = dict(
    ...
    test=dict(
            type=dataset_type,
            ann_file=data_root + '/label/development_with_size.csv',
...
log_level = 'INFO'
work_dir = './work_dirs/LT_xchest_resnet50_pfc_DB_' + 'sampling4'
load_from = None
if start_epoch > 0:
