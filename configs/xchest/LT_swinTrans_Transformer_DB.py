freq_file_in_loss = 'mllt/appendix/chestdevkit_sampling4/class_freq.pkl'
# work_dir = './work_dirs/LT_xchest_resnet50_pfc_DB_part3_' + 'sampling4'
work_dir = './work_dirs/LT_swinTrans_Transformer_DB_' + 'sampling4'
ann_csv_train = "/label/sampling4.csv"
ann_csv_val =   "/label/sampling4.csv"
